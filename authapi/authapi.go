...
func (api *AuthApi) PingWithContext(ctx context.Context) (*PingResult, error) {
	_, body, err := api.CallWithContext(ctx, "GET", "/auth/v2/ping", nil, duoapi.UseTimeout)
	if err != nil {
		return nil, err
	}
	ret := &PingResult{}
...
func (api *AuthApi) Ping() (*PingResult, error) {
	return api.PingWithContext(context.Background())
}
...
func (api *AuthApi) CheckWithContext(ctx context.Context) (*CheckResult, error) {
	_, body, err := api.SignedCallWithContext(ctx, "GET", "/auth/v2/check", nil, duoapi.UseTimeout)
	if err != nil {
		return nil, err
	}
	ret := &CheckResult{}
...
func (api *AuthApi) Check() (*CheckResult, error) {
	return api.CheckWithContext(context.Background())
}
...
func (api *AuthApi) LogoWithContext(ctx context.Context) (*LogoResult, error) {
	resp, body, err := api.SignedCallWithContext(ctx, "GET", "/auth/v2/logo", nil, duoapi.UseTimeout)
	if err != nil {
		return nil, err
	}
...
func (api *AuthApi) Logo() (*LogoResult, error) {
	return api.LogoWithContext(context.Background())
}
...
func (api *AuthApi) EnrollWithContext(ctx context.Context, options ...func(*url.Values)) (*EnrollResult, error) {
	opts := url.Values{}
	for _, o := range options {
		o(&opts)
	}

	_, body, err := api.SignedCallWithContext(ctx, "POST", "/auth/v2/enroll", opts, duoapi.UseTimeout)
	if err != nil {
		return nil, err
	}
	ret := &EnrollResult{}
...
func (api *AuthApi) Enroll(options ...func(*url.Values)) (*EnrollResult, error) {
	return api.EnrollWithContext(context.Background(), options...)
}
...
func (api *AuthApi) EnrollStatusWithContext(ctx context.Context,
	userid string,
	...
	_, body, err := api.SignedCallWithContext(ctx, "POST",
...
func (api *AuthApi) EnrollStatus(userid string,
	activationCode string) (*EnrollStatusResult, error) {
	return api.EnrollStatusWithContext(context.Background(),
		userid,
		activationCode)
}
...
func (api *AuthApi) PreauthWithContext(ctx context.Context, options ...func(*url.Values)) (*PreauthResult, error) {
	opts := url.Values{}
	for _, o := range options {
		o(&opts)
	}
	_, body, err := api.SignedCallWithContext(ctx, "POST", "/auth/v2/preauth", opts, duoapi.UseTimeout)
	if err != nil {
		return nil, err
	}
	ret := &PreauthResult{}
...
func (api *AuthApi) Preauth(options ...func(*url.Values)) (*PreauthResult, error) {
	return api.PreauthWithContext(context.Background(), options...)
}
...
func (api *AuthApi) AuthWithContext(ctx context.Context, factor string, options ...func(*url.Values)) (*AuthResult, error) {
	params := url.Values{}
	for _, o := range options {
		o(&params)
	}
	...
	_, body, err := api.SignedCallWithContext(ctx, "POST", "/auth/v2/auth", params, apiOps...)
	if err != nil {
		return nil, err
	}
	ret := &AuthResult{}
...
func (api *AuthApi) Auth(factor string, options ...func(*url.Values)) (*AuthResult, error) {
	return api.AuthWithContext(context.Background(), factor, options...)
}
...
func (api *AuthApi) AuthStatusWithContext(ctx context.Context, txid string) (*AuthStatusResult, error) {
	opts := url.Values{}
	opts.Set("txid", txid)
	_, body, err := api.SignedCallWithContext(ctx, "GET", "/auth/v2/auth_status", opts)
	if err != nil {
		return nil, err
	}
...
func (api *AuthApi) AuthStatus(txid string) (*AuthStatusResult, error) {
	return api.AuthStatusWithContext(context.Background(), txid)
}
